...
{
  $Pod::Weaver::Section::RSRCHBOY::RoleParameters::VERSION = '0.033';
}
...
This document describes version 0.033 of Pod::Weaver::Section::RSRCHBOY::RoleParameters - released January 09, 2013 as part of Dist-Zilla-PluginBundle-RSRCHBOY.
