...
{
  $Pod::Weaver::Section::RSRCHBOY::RoleParameters::VERSION = '0.034';
}
...
This document describes version 0.034 of Pod::Weaver::Section::RSRCHBOY::RoleParameters - released February 23, 2013 as part of Dist-Zilla-PluginBundle-RSRCHBOY.
